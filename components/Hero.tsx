...
export const Hero: React.FC = () => {
  ...
  return (
    <section // Changed from div to section for better semantics
      id="home"
      aria-label="Welcome to CHC Dhamnagar" // Helps screen readers understand this section's purpose
      className="scroll-mt-24 relative pt-24 pb-16 md:pt-32 md:mt-10 md:pb-24 overflow-hidden bg-slate-50 dark:bg-slate-900 transition-colors duration-300"
    >
      {/* Abstract Background Shape - kept as is */}
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-medical-100 dark:bg-medical-900/30 opacity-50 blur-3xl" aria-hidden="true"></div>
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72 rounded-full bg-blue-100 dark:bg-blue-900/30 opacity-50 blur-3xl" aria-hidden="true"></div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            ...
            <h1 className="text-4xl tracking-tight font-extrabold text-slate-900 dark:text-white sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              <span className="block xl:inline">{t.hero.title.main}</span>{" "}
              <span className="block text-medical-600 dark:text-medical-500 xl:inline">
            ...
            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="#contact"
                  title="Contact CHC Dhamnagar for Appointments" // Tooltip for SEO & Accessibility
                ...
                <a
                  href="#departments"
                  title="View Hospital Departments"
            ...
            <div className="mt-8 border-t border-slate-200 dark:border-slate-800 pt-6 flex flex-col sm:flex-row gap-6 text-sm text-slate-500 dark:text-slate-400 justify-center lg:justify-start">
              <div className="flex items-center">
                <Clock className="w-5 h-5 text-medical-500 mr-2" aria-hidden="true" />
                {t.hero.features.emergency}
              </div>
              <div className="flex items-center">
                <CheckCircle className="w-5 h-5 text-medical-500 mr-2" aria-hidden="true" />
                {t.hero.features.consultation}
              </div>
              <div className="flex items-center">
                <CheckCircle className="w-5 h-5 text-medical-500 mr-2" aria-hidden="true" />
          ...
          {/* Hero Image - CRITICAL SEO SECTION */}
          <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
            <div className="relative mx-auto w-full rounded-2xl shadow-2xl lg:max-w-xl overflow-hidden transform hover:scale-[1.001] transition-transform duration-500">
              <img
                ...
                alt="Exterior view of Community Health Center (CHC) Dhamnagar building" // Made alt text more descriptive
                // PERFORMANCE OPTIMIZATIONS:
                loading="eager" // Forces immediate load (never lazy load the hero image)
                fetchPriority="high" // Tells browser this is the most important image on page
                width="600" // Prevents layout shift (CLS)
                height="400" // Prevents layout shift (CLS)
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <p className="font-semibold text-lg">
                    {t.hero.imageCaption.main}
                  </p>
                  <p className="text-sm opacity-90">
                    {t.hero.imageCaption.sub}
                  </p>
                </div>
              </div>
            </div>
